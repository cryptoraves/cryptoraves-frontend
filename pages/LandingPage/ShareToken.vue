<template>
  <div class="sharetoken">
    <div class="container">
      <SectionHeader>SHARE Tokens! It's FUN!</SectionHeader>
      <div class="row sharetoken-content">
        ...
        <div class="col-lg-6 mt-2">
          ...
          <div class="space-10"/>
          <div>
            <div class="sharetoken-method-connect"/>
...
.sharetoken-tweet-button button {
  margin-top: 20px;
}
