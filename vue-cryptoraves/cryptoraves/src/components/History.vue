...
export default {
    ...
    methods: {
        ...
        getHistory(user, initFlag){
            if(initFlag == 0){
                axios.get('https://4mjt8xbsni.execute-api.us-east-1.amazonaws.com/prod?pageType=transactionHistory&userName='+user)
                .then(response => {
                ...
                axios.get('https://4mjt8xbsni.execute-api.us-east-1.amazonaws.com/prod?pageType=transactionHistory&userName='+user+"&earliestDatetime="+this.earliestDatetime)
                .then(response => {
                    // JSON responses are automatically parsed.        
                    this.user = user;
                    let res = response.data;
                ...
                axios.get('https://4mjt8xbsni.execute-api.us-east-1.amazonaws.com/prod?pageType=transactionHistory&userName='+user+"&latestDatetime="+this.latestDatetime)
                .then(response => {
                    // JSON responses are automatically parsed.        
                    this.user = user;
                    let res = response.data;
