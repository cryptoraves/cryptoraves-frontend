<template>
  ...
  <div v-bind:class="[ tokensearch ? 'token-container' : 'app-container']">
    <div
      class="d-flex"
    ...
    >
      <input
        ...
        @keyup.up="onArrowUp"
        @focus="inputFocused"
        v-bind:class="[ tokensearch ? 'token-header-input' : 'app-header-input']"
    ...
    <div
      id="searchResult"
      v-show="openSearch"
      v-bind:class="[ tokensearch ? 'token-header-search-result' : 'app-header-search-result']"
    >
      <div
